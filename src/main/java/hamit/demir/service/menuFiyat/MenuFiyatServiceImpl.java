...
public class MenuFiyatServiceImpl implements MenuFiyatService {
    ...
    @Override
    public MenuFiyatAllResponse getMenuFiyatById(Long id) {
    ...
    public Long updateMenuFiyat(MenuFiyatUpdateRequest request) {
        MenuFiyatEntity entity = menuFiyatRepository.findById(request.id())
                .orElseThrow(() -> new BaseException(
                        GenericResponse.error("MenuFiyat Bulunamadı! Lütfen tekrar deneyiniz..", HttpStatus.NOT_FOUND.toString())));
        entity.setFiyat(request.fiyat());
    ...
    @Override
    public List<MenuFiyatAllResponse> getAllMenuFiyatList() {
